  ...
  const plans = [
    {
      ...
      features: [
        { text: "خطة دراسية أساسية", included: true },
        { text: "3 ملخصات أسبوعياً", included: true },
        { text: "اختبارات أساسية", included: true },
        { text: "مؤقت بومودورو", included: false },
    ...
    },
    {
      ...
      features: [
        { text: "خطة دراسية شاملة", included: true },
        { text: "ملخصات يومية غير محدودة", included: true },
        { text: "اختبارات متقدمة مع تحليلات", included: true },
        { text: "مؤقت بومودورو ذكي", included: true },
